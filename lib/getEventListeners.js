...
// 覆盖原生的 addEventListener、removeEventListener
// 为每个元素记录事件处理函数列表 eventListenerList 和禁用的事件类型列表 disableEventTypeList

// 为每个元素新增 getEventListeners、clearEventListeners、disableEventListeners、enableEventListeners 方法
// 可以获取、删除、禁用、启用指定的事件处理函数

// 使用 document 的 disableEventListeners、enableEventListeners 方法
// 可以全局禁用、启用某一类的事件处理函数
